...
JarsAuth will check all files in the configured folders and calculate their hash values, which are used to generate the hash code of the whole client.
...
<li> Go to client folder \.minecraft\config\jarsauth-client.toml , you can change or add any folders in '\.minecraft', which will be checked by JarsAuth.</li>
