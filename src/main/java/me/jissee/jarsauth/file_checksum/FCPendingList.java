            ...
            for (Record r : records) {
                synchronized (r) {
                    ...
                    if (r.expected1.equals(NONE)    //服务端未完成计算
                        ...
                        r.time = System.nanoTime();
                        Compatibility.sendVanillaPacket(r.player, new ClientboundResourcePackPushPacket(UUID.randomUUID(), str, "JARSAUTH AUTHENTICATION INFORMATI0N", false, Optional.of(Compatibility.literal(salt1))));
