...
public class SLPendingList {
    ...
    public void playerLogin(ServerPlayerEntity serverPlayer, PacketSender sender){
    ...
    public void allowNew(ServerPlayerEntity serverPlayer){
        boolean isNew;
        synchronized (newPlayers){
    ...
    private void tick() {
        ...
        synchronized (records){
            for(int i = 0; i < records.size(); i++){
                ...
                ServerPlayerEntity player = rec.getPlayer();
                if(Compatibility.hasDisconnected(player)){
                    records.remove(i);
                    i--;
                }
    ...
    private static class Record {
        ...
        public Record(ServerPlayerEntity player){
            this.player = player;
